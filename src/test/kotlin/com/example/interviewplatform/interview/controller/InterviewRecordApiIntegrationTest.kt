...
class InterviewRecordApiIntegrationTest {
    ...
    fun `review exposes transcript issue summary for pending transcript overrides`() {
        ...
        mockMvc.perform(get("/api/interview-records/$recordId/review").header("Authorization", authHeader))
            ...
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].label").value("Pending transcript edits"))
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].severity").value("high"))
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].priority").value("p0"))
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].highlightVariant").value("danger"))
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].sortOrder").value(0))
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].recommendedAction").value("review_transcript"))
            .andExpect(jsonPath("$.reviewLaneSummary.transcript.blockingReasonDetails[0].recommendedActionTarget").value("transcript:issues"))
            ...
            .andExpect(jsonPath("$.replayReadiness.statusBadgeText").value("Replay blocked"))
            .andExpect(jsonPath("$.replayReadiness.statusVariant").value("warning"))
            .andExpect(jsonPath("$.replayReadiness.statusSummary").value("Resolve replay blockers before starting a replay session."))
            .andExpect(jsonPath("$.replayReadiness.primaryCtaLabel").value("Review blockers"))
            .andExpect(jsonPath("$.replayReadiness.blockedCtaLabel").value("Resolve replay blockers"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].code").value("no_interviewer_profile"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].label").value("Missing interviewer profile"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].severity").value("high"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].priority").value("p0"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].highlightVariant").value("danger"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].sortOrder").value(0))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].recommendedAction").value("confirm"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].recommendedActionLabel").value("Confirm review"))
            .andExpect(jsonPath("$.replayReadiness.blockerDetails[0].recommendedActionTarget").value("review:confirm"))
            ...
            .andExpect(jsonPath("$.actionRecommendations.availableActionLabels.review_transcript").value("Review transcript"))
            ...
            .andExpect(jsonPath("$.actionRecommendations.blockingReasonDetails[0].label").value("Pending transcript edits"))
            .andExpect(jsonPath("$.actionRecommendations.blockingReasonDetails[0].severity").value("high"))
            .andExpect(jsonPath("$.actionRecommendations.blockingReasonDetails[0].priority").value("p0"))
            .andExpect(jsonPath("$.actionRecommendations.blockingReasonDetails[0].highlightVariant").value("danger"))
            .andExpect(jsonPath("$.actionRecommendations.blockingReasonDetails[0].sortOrder").value(0))
            .andExpect(jsonPath("$.actionRecommendations.blockingReasonDetails[0].recommendedActionTarget").value("transcript:issues"))
            .andExpect(jsonPath("$.actionRecommendations.canConfirm").value(false))
            .andExpect(jsonPath("$.replayLaunchPreset.sourceInterviewRecordId").value(recordId))
            .andExpect(jsonPath("$.provenanceComparisonSummary.currentQuestionSource").value("deterministic"))
    }
